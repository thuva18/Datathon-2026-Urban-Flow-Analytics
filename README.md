...
#### Track 2.2: On-Time Arrival Estimator (Trip Duration Model)
- **Model**: `HistGradientBoostingRegressor` (predicting `trip_duration_min`)
- **Validation**: RMSE = 7.20 mins | MAE = 4.28 mins | $R^2$ = 0.7286
- **Test Set**: **RMSE = 7.09 mins | MAE = 4.03 mins | $R^2$ = 0.7585**

#### Track 3.1: Fleet Dispatch Demand Forecasting
...
- K-Means clustering ($k=4$) on 24-hour diurnal zone demand profiles, categorizing 258 taxi zones into behavioral patterns (e.g., Morning Commuter Hubs vs. Evening Entertainment Districts).
